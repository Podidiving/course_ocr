...
from .data_reader import ArchivedHWDBReader, HWDBDatasetHelper
...
def parse_args() -> Namespace:
    ...
    parser.add_argument("--encoder", type=str, default="/notebook/temp/encoder.pkl")
    parser.add_argument("--test", type=str, default="/notebook/temp/Test/UNKNOWN")
...
def main(args: Namespace):
    ...
    test_loader = DataLoader(test_dataset, batch_size=2048, shuffle=False, num_workers=10)
